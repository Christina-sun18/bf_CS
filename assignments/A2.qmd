...
<i class="bi bi-download"></i> [IA2_template.qmd](../assignment_data/IA2_template.qmd.zip){download="IA2_template.qmd.zip"}
:::

* Download the data

::: {.callout appearance="minimal"}
<i class="bi bi-download"></i> [IA_data.csv](../assignment_data/IA_data.csv.zip){download="IA_data.csv.zip"}
:::
